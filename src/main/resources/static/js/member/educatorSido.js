...
const koreaData = {
    ...
    "제주특별자치도":[	"제주시", "서귀포시" ]
       ...
       const educatorInfo = document.getElementById("educatorInfo");
       ...
       const sigunguSelect = document.getElementById("sigungu");
        ...
        roleSelect.addEventListener("change", function () {
            if (this.value === "EDUCATOR") {
                // 교육자 회원 유형인 경우 시도, 시군구, 학원명 입력란을 보이게 함
                educatorInfo.style.display = "block";
            } else {
                // 다른 회원 유형인 경우 숨김
                educatorInfo.style.display = "none";
            }
        });
        ...
        // 시도 변경 시 시군구 옵션 업데이트 함수
        function updateSigunguOptions(selectedSido) {
            const sigunguOptions = koreaData[selectedSido] || []; // 선택한 시도에 해당하는 시군구 목록 가져오기
        ...
        sidoSelect.addEventListener("change", function () {
            const selectedSido = this.value; // 선택한 시도
            updateSigunguOptions(selectedSido); // 시군구 옵션 업데이트 함수 호출
        });
